...
<?php if (!isset($_SERVER['HTTP_X_PJAX'])) { ?>
    <div id="footer">
        Copyright &copy; 2006-<?php echo date('Y'); ?>&nbsp;<?php echo (string) $ost->company ?: 'trc-con.com'; ?>&nbsp;All Rights Reserved.
    </div>
<?php
...
<div id="loading">
    ...
    <h1><?php echo __('กำลังดำเนินการ ...');?></h1>
</div>
...
<div style="display:none;" class="dialog" id="alert">
    ...
    <p class="full-width">
        <span class="buttons pull-right">
            <input type="button" value="<?php echo __('โอเค');?>" class="close">
        </span>
     </p>
    <div class="clear"></div>
</div>
