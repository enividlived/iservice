...
<div class="pull-left" style="width:700px;">
 ...
 <div class="pull-right flush-right">
    ...
    echo __('สร้างบริษัทใหม่'); ?></a></b></div>
<div class="clear"></div>
<?php
$showing = $search ? __('ผลการค้นหา').': ' : '';
$res = db_query($query);
if($res && ($num=db_num_rows($res)))
    $showing .= $pageNav->showing();
else
    $showing .= __('ไม่พบบริษัท!');
?>
<form action="orgs.php" method="POST" name="staff" >
 ...
 <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    ...
    <thead>
        <tr>
            <th width="400"><a <?php echo $name_sort; ?> href="orgs.php?<?php echo $qstr; ?>&sort=name"><?php echo __('ชื่อ'); ?></a></th>
            <th width="100"><a <?php echo $users_sort; ?> href="orgs.php?<?php echo $qstr; ?>&sort=users"><?php echo __('ผู้ใช้'); ?></a></th>
            <th width="150"><a <?php echo $create_sort; ?> href="orgs.php?<?php echo $qstr; ?>&sort=create"><?php echo __('สร้างเมื่อ'); ?></a></th>
            <th width="145"><a <?php echo $update_sort; ?> href="orgs.php?<?php echo $qstr; ?>&sort=update"><?php echo __('อัพเดทล่าสุด'); ?></a></th>
        </tr>
    </thead>
    <tbody>
    <?php
