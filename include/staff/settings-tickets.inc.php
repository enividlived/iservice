...
?>
<h2><?php echo __('การตั้งค่าคำขอใช้บริการ');?></h2>
...
<table class="form_table settings_table" width="940" border="0" cellspacing="0" cellpadding="2">
    <thead>
        <tr>
            <th colspan="2">
                <h4><?php echo __('การตั้งค่าคำขอใช้บริการทั้งระบบ');?></h4>
                <em><?php echo __('การตั้งค่าคำขอใช้บริการมีผลโดยรวมทั้งระบบ'); ?></em>
            </th>
        </tr>
    </thead>
    <tbody>
        <tr>
            ...
            <td>
                ...
                <span class="faded"><?php echo __('ตัวอย่าง'); ?> <span id="format-example"><?php
        ...
        <tr><td width="220"><?php echo __('รูปแบบการเรียงลำดับคำขอใช้บริการ'); ?>:</td>
...
<?php } ?>
        ...
        <tr>
            <td width="180" class="required"><?php echo __('ความสำคัญเริ่มต้น');?>:</td>
            <td>
        ...
        <tr>
            <td width="180"><?php echo __('บริการเริ่มต้น'); ?>:</td>
            <td>
                <select name="default_help_topic">
                    <option value="0">&mdash; <?php echo __('ไม่มี'); ?> &mdash;</option><?php
        ...
        <tr>
            <td><?php echo __('จำนวนคำขอใช้บริการ <b>สูงสุด</b>');?>:</td>
            <td>
                <input type="text" name="max_open_tickets" size=4 value="<?php echo $config['max_open_tickets']; ?>">
                <?php echo __('ต่อผู้ใช้หนึ่งคน'); ?> <i class="help-tip icon-question-sign" href="#maximum_open_tickets"></i>
            </td>
        </tr>
        <tr>
            <td><?php echo __('ป้องกันเจ้าหน้าที่รับงานซ้อน'); ?>:</td>
            <td>
                <input type="text" name="autolock_minutes" size=4 value="<?php echo $config['autolock_minutes']; ?>">
                <font class="error"><?php echo $errors['autolock_minutes']; ?></font>&nbsp;<?php echo __('นาที'); ?>&nbsp;<i class="help-tip icon-question-sign" href="#agent_collision_avoidance"></i>
            </td>
        </tr>
        <tr>
            <td><?php echo __('ตรวจสอบความเป็นมนุษย์');?>:</td>
            <td>
                <input type="checkbox" name="enable_captcha" <?php echo $config['enable_captcha']?'checked="checked"':''; ?>>
                <?php echo __('เปิดใช้งาน CAPTCHA เมื่อสร้างคำขอใช้บริการ');?>
                &nbsp;<font class="error">&nbsp;<?php echo $errors['enable_captcha']; ?></font>
                &nbsp;<i class="help-tip icon-question-sign" href="#human_verification"></i>
            </td>
        </tr>
        <tr>
            <td><?php echo __('รับคำขอใช้บริการทันทีเมื่อตอบกลับ'); ?>:</td>
            <td>
                <input type="checkbox" name="auto_claim_tickets" <?php echo $config['auto_claim_tickets']?'checked="checked"':''; ?>>
                <?php echo __('เปิดใช้งาน'); ?>&nbsp;<i class="help-tip icon-question-sign" href="#claim_tickets"></i>
            </td>
        </tr>
        <tr>
            <td><?php echo __('คำขอใช้บริการมอบหมายแล้ว');?>:</td>
            <td>
                <input type="checkbox" name="show_assigned_tickets" <?php
                echo !$config['show_assigned_tickets']?'checked="checked"':''; ?>>
                <?php echo __('ไม่แสดงคำขอใช้บริการที่มอบหมายแล้ว ในหน้าคำขอใช้บริการใหม่'); ?>
                <i class="help-tip icon-question-sign" href="#assigned_tickets"></i>
            </td>
        </tr>
        <tr>
            <td><?php echo __('คำขอใช้บริการมีการตอบกลับ');?>:</td>
            <td>
                <input type="checkbox" name="show_answered_tickets" <?php
                echo !$config['show_answered_tickets']?'checked="checked"':''; ?>>
                <?php echo __('ไม่แสดงคำขอใช้บริการที่มีการตอบกลับ ในหน้าคำขอใช้บริการใหม่'); ?>
                <i class="help-tip icon-question-sign" href="#answered_tickets"></i>
            </td>
        </tr>
        <tr>
            <td><?php echo __('ซ่อนตัวตนเจ้าหน้าที่'); ?>:</td>
            <td>
                <input type="checkbox" name="hide_staff_name" <?php echo $config['hide_staff_name']?'checked="checked"':''; ?>>
                <?php echo __("ซ่อนชื่อเจ้าหน้าที่ เมื่อตอบคำขอใช้บริการ"); ?>
                <i class="help-tip icon-question-sign" href="#staff_identity_masking"></i>
            </td>
        </tr>
        <tr>
            <td><?php echo __('เปิดใช้งานการสร้างคำขอใช้บริการด้วย HTML'); ?>:</td>
            <td>
                <input type="checkbox" name="enable_html_thread" <?php
                echo $config['enable_html_thread']?'checked="checked"':''; ?>>
                <?php echo __('เปิดใช้ระบบสร้างหรือตอบกลับคำขอใช้บริการด้วย HTML'); ?>
                <i class="help-tip icon-question-sign" href="#enable_html_ticket_thread"></i>
            </td>
        </tr>
        <tr>
            <td><?php echo __('อนุญาตให้ผู้ใช้แก้ไขคำขอใช้บริการ'); ?>:</td>
            <td>
                <input type="checkbox" name="allow_client_updates" <?php
                echo $config['allow_client_updates']?'checked="checked"':''; ?>>
                <?php echo __('อนุญาตให้ส่วนของผู้ใช้ สามารถแก้ไขคำขอใช้บริการของตนเองได้'); ?>
            </td>
        </tr>
        <tr>
            <th colspan="2">
                <em><b><?php echo __('ไฟล์แนบ');?></b>:  <?php echo __('กำหนดขนาดหรือจำนวนไฟล์สูงสุดที่สามารถอัพโหลดได้ เมื่อสร้างคำขอใช้บริการ');?></em>
            </th>
        </tr>
        <tr>
            <td width="180"><?php echo __('การตั้งค่าไฟล์แนบให้คำขอใช้บริการ');?>:</td>
            <td>
<?php
...
?>
                <a class="action-button field-config" style="overflow:inherit"
                    ...
                    onclick="javascript:
                        ...
                        return false;
                    "><i class="icon-edit"></i> <?php echo __('ตั้งค่า'); ?></a>
                <i class="help-tip icon-question-sign" href="#ticket_attachment_settings"></i>
            </td>
        </tr>
        <tr>
            <td width="180"><?php echo __('ขนาดไฟล์สูงสุด');?>:</td>
            <td>
                <select name="max_file_size">
                    <option value="262144">&mdash; <?php echo __('เล็ก'); ?> &mdash;</option>
                    <?php $next = 512 << 10;
        ...
        <?php if (($bks = FileStorageBackend::allRegistered())
                && count($bks) > 1) { ?>
        <tr>
            <td width="180"><?php echo __('เก็บไฟล์แนบ'); ?>:</td>
