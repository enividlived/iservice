...
if( ($startTime && $startTime>time()) or ($startTime>$endTime && $endTime>0)){
    $errors['err']=__('ช่วงเวลาที่กรอกผิดพลาด การเลือกถูกยกเลิก');
    $startTime=$endTime=0;
}else{
    if($startTime){
...
if($res && ($num=db_num_rows($res)))
    ...
    $showing=__('ไม่พบล็อก!');
?>

<h2><?php echo __('ล็อกระบบ');?>
    &nbsp;<i class="help-tip icon-question-sign" href="#system_logs"></i>
</h2>
<div id='filter' >
 <form action="logs.php" method="get">
    <div style="padding-left:2px;">
        <b><?php echo __('ช่วงวัน'); ?></b>&nbsp;<i class="help-tip icon-question-sign" href="#date_span"></i>
        <?php echo __('ระหว่าง'); ?>:
        ...
        &nbsp;<?php echo __('ระดับล็อก'); ?>:&nbsp;<i class="help-tip icon-question-sign" href="#type"></i>
            <select name='type'>
                <option value="" selected><?php echo __('ทั้งหมด');?></option>
            ...
            &nbsp;&nbsp;
            <input type="submit" Value="<?php echo __('ดำเนินการ!');?>" />
    </div>
 </form>
</div>
...
<?php csrf_token(); ?>
 ...
 <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    ...
    <thead>
        <tr>
            <th width="7">&nbsp;</th>
            <th width="320"><a <?php echo $title_sort; ?> href="logs.php?<?php echo $qstr; ?>&sort=title"><?php echo __('ชื่อล็อก');?></a></th>
            <th width="100"><a  <?php echo $type_sort; ?> href="logs.php?<?php echo $qstr; ?>&sort=type"><?php echo __('ประเภทล็อก');?></a></th>
            <th width="200" nowrap><a  <?php echo $date_sort; ?>href="logs.php?<?php echo $qstr; ?>&sort=date"><?php echo __('วันที่');?></a></th>
            <th width="120"><a  <?php echo $ip_sort; ?> href="logs.php?<?php echo $qstr; ?>&sort=ip"><?php echo __('หมายเลข IP');?></a></th>
        </tr>
    </thead>
    <tbody>
    <?php
...
<p class="centered" id="actions">
    <input class="button" type="submit" name="delete" value="<?php echo __('ลบรายการที่เลือก');?>">
</p>
<?php
endif;
?>
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong><?php echo sprintf(__('คุณแน่ใจหรือว่าต้องการลบ %s?'),
            _N('รายการล็อกที่เลือก', 'รายการล็อกที่เลือก', 2));?></strong></font>
