...
if($template && $_REQUEST['a']!='add'){
    ...
    $title=__('สร้างเท็มเพลตใหม่');
    $action='add';
    $submit_text=__('สร้างเท็มเพลต');
...
<form action="templates.php?<?php echo $qstr; ?>" method="post" id="save">
 ...
 <h2><?php echo __('เท็มเพลตอีเมล');?></h2>
 <table class="form_table" width="940" border="0" cellspacing="0" cellpadding="2">
    <thead>
        <tr>
            <th colspan="2">
                <h4><?php echo $title; ?></h4>
                <em><?php echo __('ข้อมูลเท็มเพลต');?></em>
            </th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td>
                <span>
                <label><input type="radio" name="isactive" value="1" <?php echo $info['isactive']?'checked="checked"':''; ?>><strong>&nbsp;<?php echo __('เปิดใช้งาน'); ?></strong></label>
                &nbsp;
                <label><input type="radio" name="isactive" value="0" <?php echo !$info['isactive']?'checked="checked"':''; ?>>&nbsp;<?php echo __('ปิดใช้งาน'); ?></label>
        ...
        <tr>
            ...
            :: <?php echo __('คลิกที่ชื่อเพื่อแก้ไข'); ?></em>
            </th>
        </tr>
<?php } # end if ($current_group)
            if (isset($impl[$cn])) {
                ...
                sprintf(__('ปรับปรุง %s'), Format::db_datetime($impl[$cn]->getLastUpdated())),
        ...
        <tr>
            <td width="180" class="required">
                <?php echo __('เท็มเพลตถูกตั้งให้โคลน');?>:
            </td>
            <td>
    ...
    if ($(this).val() == 0)
        ...
        $('#language').hide();
">
                    <option value="0">&mdash; <?php echo __('เท็มเพลตที่เก็บไว้'); ?> &mdash;</option>
                    <?php
...
<tbody>
        ...
        <tr>
            <th colspan="2">
                <em><strong><?php echo __('บันทึกภายใน');?></strong>: <?php echo __(
                "บันทึกภายในสำหรับเจ้าหน้าที่");?></em>
            </th>
        </tr>
        <tr>
            <td colspan=2>
...
<p style="text-align:center">
    ...
    <input type="button" name="cancel" value="<?php echo __('ยกเลิก');?>" onclick='window.location.href="templates.php"'>
</p>
</form>
