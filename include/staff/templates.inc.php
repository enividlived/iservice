...
if($res && ($num=db_num_rows($res)))
    ...
    $showing=__('ไม่พบเท็มเพลต!');

?>

<div class="pull-left" style="width:700px;padding-top:5px;">
 <h2><?php echo __('ตั้งค่าชุดเท็มเพลตอีเมล'); ?></h2>
</div>
<div class="pull-right flush-right" style="padding-top:5px;padding-right:5px;">
 <b><a href="templates.php?a=add" class="Icon newEmailTemplate"><?php echo __('สร้างชุดเท็มเพลตใหม่'); ?></a></b></div>
<div class="clear"></div>
...
<input type="hidden" id="action" name="a" value="" >
 <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    ...
    <thead>
        <tr>
            <th width="7">&nbsp;</th>
            <th width="350"><a <?php echo $name_sort; ?> href="templates.php?<?php echo $qstr; ?>&sort=name"><?php echo __('ชื่อ'); ?></a></th>
            <th width="100"><a  <?php echo $status_sort; ?> href="templates.php?<?php echo $qstr; ?>&sort=status"><?php echo __('สถานะ'); ?></a></th>
            <th width="80"><a <?php echo $inuse_sort; ?> href="templates.php?<?php echo $qstr; ?>&sort=inuse"><?php echo __('กำลังใช้งาน'); ?></a></th>
            <th width="120" nowrap><a  <?php echo $created_sort; ?>href="templates.php?<?php echo $qstr; ?>&sort=created"><?php echo __('สร้างเมื่อ'); ?></a></th>
            <th width="150" nowrap><a  <?php echo $updated_sort; ?>href="templates.php?<?php echo $qstr; ?>&sort=updated"><?php echo __('อัพเดทล่าสุด'); ?></a></th>
        </tr>
    </thead>
    <tbody>
    <?php
        ...
        if($res && db_num_rows($res)):
            ...
            while ($row = db_fetch_array($res)) {
                ...
                $default=($defaultTplId==$row['tpl_id'])?'<small class="fadded">('.__('ค่าเริ่มต้นระบบ').')</small>':'';
                ?>
            <tr id="<?php echo $row['tpl_id']; ?>">
                ...
                <td>&nbsp;&nbsp;<?php echo ($inuse)?'<b>'.__('ใช่').'</b>':__('ไม่ใช่'); ?></td>
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="enable-confirm">
        <?php echo sprintf(__('คุณแน่ใจหรือว่าต้องการ <b>เปิดใช้งาน</b> %s?'),
            _N('ชุดเท็มเพลตที่เลือก', 'ชุดเท็มเพลตที่เลือก', 2));?>
    </p>
    ...
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong><?php echo sprintf(__('คุณแน่ใจหรือว่าต้องการลบ %s?'),
            _N('ชุดเท็มเพลตที่เลือก', 'ชุดเท็มเพลตที่เลือก', 2));?></strong></font>
