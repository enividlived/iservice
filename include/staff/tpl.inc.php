...
<h2><span><?php echo __('ชุดเท็มเพลตอีเมล');
...
<div class="pull-right">
    <span style="font-size:10pt"><?php echo __('กำลังดู'); ?>:</span>
    <select id="tpl_options" name="id" style="width:300px;">
        <option value="">&mdash; <?php echo __('เลือกกลุ่มที่ตั้งค่า'); ?> &mdash;</option>
        <?php
...
<h3 style="font-size:12pt;margin:0"><?php echo __($desc['name']); ?>
    ...
    <i class="icon-tags"></i>
    <?php echo __('ตัวแปรที่สนับสนุน'); ?></a>
    </h3>
<?php if ($errors) { ?>
...
<div style="padding-bottom:3px;" class="faded"><strong><?php echo __('หัวข้อและเนื้อหาอีเมล'); ?>:</strong></div>
<div id="toolbar"></div>
...
<p style="text-align:center">
    ...
    <input class="button" type="reset" name="reset" value="<?php echo __('รีเซ็ต'); ?>" onclick="javascript:
        setTimeout('location.reload()', 25);" />
    <input class="button" type="button" name="cancel" value="<?php echo __('ยกเลิก'); ?>"
