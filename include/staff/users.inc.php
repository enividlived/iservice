...
?>
<h2><?php echo __('สารบัญผู้ใช้'); ?></h2>
<div class="pull-left" style="width:700px;">
 ...
 <div class="pull-right flush-right" style="padding-right:5px;">
    <b><a href="#users/add" class="Icon newstaff popup-dialog"><?php echo __('เพิ่มผู้ใช้'); ?></a></b>
    |
    <b><a href="#users/import" class="popup-dialog"><i class="icon-cloud-upload icon-large"></i>
    <?php echo __('นำเข้า'); ?></a></b>
</div>
<div class="clear"></div>
<?php
    ...
    <thead>
        <tr>
            <th width="350"><a <?php echo $name_sort; ?> href="users.php?<?php
                echo $qstr; ?>&sort=name"><?php echo __('ชื่อ'); ?></a></th>
            <th width="250"><a  <?php echo $status_sort; ?> href="users.php?<?php
                echo $qstr; ?>&sort=status"><?php echo __('สถานะ'); ?></a></th>
            <th width="100"><a <?php echo $create_sort; ?> href="users.php?<?php
                echo $qstr; ?>&sort=create"><?php echo __('สร้างเมื่อ'); ?></a></th>
            <th width="145"><a <?php echo $update_sort; ?> href="users.php?<?php
                echo $qstr; ?>&sort=update"><?php echo __('อัพเดทเมื่อ'); ?></a></th>
        </tr>
    </thead>
    <tbody>
    <?php
...
if($res && $num): //Show options..
    echo sprintf('<div>&nbsp;'.__('หน้า').': %s &nbsp; <a class="no-pjax"
            href="users.php?a=export&qh=%s">'.__('นำออก').'</a></div>',
