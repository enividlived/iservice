!function($) {
  ...
  FileDropbox.prototype = {
    ...
    handleError: function(err, file, i, status) {
      ...
      $.sysAlert(__('อัพโหลดไฟล์ล้มเหลว'), message);
    ...
    lockSubmit: function() {
      ...
      $submit.val(__('กำลังอัพโหลด ...')).prop('disabled', true);
    }
  };
  ...
  $.fn.filedropbox.messages = {
    'BrowserNotSupported': __('ไม่รองรับเบราว์เซอร์ของคุณ'),
    'TooManyFiles': __('อัพโหลดไฟล์มากเกินไป'),
    'FileTooLarge': __('ไฟล์ขนาดใหญ่เกินไป'),
    'FileTypeNotAllowed': __('ไม่อนุญาตให้อัพโหลดไฟล์ประเภทนี้'),
    'FileExtensionNotAllowed': __('ไม่อนุญาตให้อัพโหลดไฟล์นามสกุลนี้'),
    'NotFound': __('ไม่พบไฟล์'),
    'NotReadable': __('ไม่สามารถอ่านไฟล์'),
    'AbortError': __('พบปัญหาในการยกเลิก')
  };
