    ...
    $("form :input").change(function() {
        ...
        if(!fObj.data('changed')){
            ...
            $(window).bind('beforeunload', function(e) {
                return __("คุณแน่ใจหรือว่าจะออก? การกระทำทั้งหมดของคุณจะถูกยกเลิก!");
             });
        }
       });
        ...
        if (info && !e.data('wrapped')) {
            ...
            e.wrap(caption).parent()
                .hover(
                    ...
                    .append('<a href="'+info.download_url+'" class="action-button pull-right"><i class="icon-download-alt"></i> ' + __('ดาวน์โหลด') + '</a>')
                );
            e.data('wrapped', true);
        }
    });
