...
RedactorPlugins.fontfamily = {
    init: function ()
    {
        ...
        this.buttonAddBefore('bold', 'fontfamily', __('เปลี่ยนชุดแบบอักษร'), false, dropdown);
    },
...
RedactorPlugins.fontsize = {
	init: function()
	{
		...
		dropdown['remove'] = { title: __('ลบขนาดฟอนต์'), callback: function() { that.resetFontsize(); } };

		this.buttonAddAfter('formatting', 'fontsize', __('เปลี่ยนขนาดฟอนต์'), false, dropdown);
	},
...
RedactorPlugins.textdirection = {
    init: function()
    {
        ...
        dropdown.ltr = { title: __('ซ้ายไปขวา'), callback: this.setLtr };
        dropdown.rtl = { title: __('ขวาไปซ้าย'), callback: this.setRtl };

        var button = this.buttonAdd('textdirection', __('ทิศทางตัวอักษร'),
            false, dropdown);
