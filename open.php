...
if ($_POST) {
    ...
    if ($thisclient) {
        ...
        if(!$_POST['captcha'])
            $errors['captcha']=__('กรอกข้อความที่ปรากฎในรูปภาพ');
        elseif(strcmp($_SESSION['captcha'], md5(strtoupper($_POST['captcha']))))
            $errors['captcha']=__('ข้อความผิด!');
    }
    ...
    if(($ticket=Ticket::create($vars, $errors, SOURCE))){
        ...
        $errors['err']=$errors['err']?$errors['err']:__('ไม่สามารถสร้างคำขอใช้บริการได้ กรุณาลองใหม่อีกครั้ง!');
    }
}
