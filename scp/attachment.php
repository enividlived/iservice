...
if(!$thisstaff || !$_GET['id'] || !$_GET['h']
    ...
    Http::response(404, __('ไฟล์ผิดพลาดหรือไม่ถูกต้อง'));
...
if(strcasecmp(trim($_GET['h']),$vhash) || !($ticket=$attachment->getTicket()) || !$ticket->checkStaffAccess($thisstaff)) die(__('ปฏิเสธการเข้าถึง'));
